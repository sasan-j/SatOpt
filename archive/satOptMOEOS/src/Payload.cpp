...
vector<int> Payload::existsPathInGraph(Node* chan) { // check for a given channel object if a path to an amplifier exists.
    ...
    Port *p3;
    current = chan;
    //cout << "before getChannelsNeighborPort(current)" << endl;
    p1 = getChannelsNeighborPort(current);
    path.push_back(p1);
    //cout << "before if (p1->getSwitchPositionConnection())" << endl;
    ...
    //cout << "before while (p2->getStringConnection().empty())" << endl;

    while (p2->getStringConnection().empty()) {
        //cout << "before if (p2->getPortConnection())" << endl;
    ...
    //cout << "before if (!p2->getStringConnection().empty())" << endl;    
...
*/
    ...
    for (int r = 0; r < position_vector.size(); r++) {
...
*/
    ...
    for (int r = 0; r < chan_instance.size(); r++) {
    ...
    for (int y = 0; y < channels_to_test_path.size(); y++) {
 ...
 */
   ...
   delete s50_port_d;// new Port("s50_port_d");
    ...
    /*
    delete s1_port_l;
    s1_port_u->~Port();// new Port("s1_port_u");
    s1_port_r->~Port();// new Port("s1_port_r");
    s1_port_d->~Port();// new Port("s1_port_d");
    s2_port_l->~Port();// new Port("s2_port_l");
    s2_port_u->~Port();// new Port("s2_port_u");
    s2_port_r->~Port();// new Port("s2_port_r");
    s2_port_d->~Port();// new Port("s2_port_d");
    s3_port_l->~Port();// new Port("s3_port_l");
    s3_port_u->~Port();// new Port("s3_port_u");
    s3_port_r->~Port();// new Port("s3_port_r");
    s3_port_d->~Port();// new Port("s3_port_d");
    s4_port_l->~Port();// new Port("s4_port_l");
    s4_port_u->~Port();// new Port("s4_port_u");
    s4_port_r->~Port();// new Port("s4_port_r");
    s4_port_d->~Port();// new Port("s4_port_d");
    s5_port_l->~Port();// new Port("s5_port_l");
    s5_port_u->~Port();// new Port("s5_port_u");
    s5_port_r->~Port();// new Port("s5_port_r");
    s5_port_d->~Port();// new Port("s5_port_d");
    s6_port_l->~Port();// new Port("s6_port_l");
    s6_port_u->~Port();// new Port("s6_port_u");
    s6_port_r->~Port();// new Port("s6_port_r");
    s6_port_d->~Port();// new Port("s6_port_d");
    s7_port_l->~Port();// new Port("s7_port_l");
    s7_port_u->~Port();// new Port("s7_port_u");
    s7_port_r->~Port();// new Port("s7_port_r");
    s7_port_d->~Port();// new Port("s7_port_d");
    s8_port_l->~Port();// new Port("s8_port_l");
    s8_port_u->~Port();// new Port("s8_port_u");
    s8_port_r->~Port();// new Port("s8_port_r");
    s8_port_d->~Port();// new Port("s8_port_d");
    s9_port_l->~Port();// new Port("s9_port_l");
    s9_port_u->~Port();// new Port("s9_port_u");
    s9_port_r->~Port();// new Port("s9_port_r");
    s9_port_d->~Port();// new Port("s9_port_d");
    s10_port_l->~Port();// new Port("s10_port_l");
    s10_port_u->~Port();// new Port("s10_port_u");
    s10_port_r->~Port();// new Port("s10_port_r");
    s10_port_d->~Port();// new Port("s10_port_d");
    s11_port_l->~Port();// new Port("s11_port_l");
    s11_port_u->~Port();// new Port("s11_port_u");
    s11_port_r->~Port();// new Port("s11_port_r");
    s11_port_d->~Port();// new Port("s11_port_d");
    s12_port_l->~Port();// new Port("s12_port_l");
    s12_port_u->~Port();// new Port("s12_port_u");
    s12_port_r->~Port();// new Port("s12_port_r");
    s12_port_d->~Port();// new Port("s12_port_d");
    s13_port_l->~Port();// new Port("s13_port_l");
    s13_port_u->~Port();// new Port("s13_port_u");
    s13_port_r->~Port();// new Port("s13_port_r");
    s13_port_d->~Port();// new Port("s13_port_d");
    s14_port_l->~Port();// new Port("s14_port_l");
    s14_port_u->~Port();// new Port("s14_port_u");
    s14_port_r->~Port();// new Port("s14_port_r");
    s14_port_d->~Port();// new Port("s14_port_d");
    s15_port_l->~Port();// new Port("s15_port_l");
    s15_port_u->~Port();// new Port("s15_port_u");
    s15_port_r->~Port();// new Port("s15_port_r");
    s15_port_d->~Port();// new Port("s15_port_d");
    s16_port_l->~Port();// new Port("s16_port_l");
    s16_port_u->~Port();// new Port("s16_port_u");
    s16_port_r->~Port();// new Port("s16_port_r");
    s16_port_d->~Port();// new Port("s16_port_d");
    s17_port_l->~Port();// new Port("s17_port_l");
    s17_port_u->~Port();// new Port("s17_port_u");
    s17_port_r->~Port();// new Port("s17_port_r");
    s17_port_d->~Port();// new Port("s17_port_d");
    s18_port_l->~Port();// new Port("s18_port_l");
    s18_port_u->~Port();// new Port("s18_port_u");
    s18_port_r->~Port();// new Port("s18_port_r");
    s18_port_d->~Port();// new Port("s18_port_d");
    s19_port_l->~Port();// new Port("s19_port_l");
    s19_port_u->~Port();// new Port("s19_port_u");
    s19_port_r->~Port();// new Port("s19_port_r");
    s19_port_d->~Port();// new Port("s19_port_d");
    s20_port_l->~Port();// new Port("s20_port_l");
    s20_port_u->~Port();// new Port("s20_port_u");
    s20_port_r->~Port();// new Port("s20_port_r");
    s20_port_d->~Port();// new Port("s20_port_d");
    s21_port_l->~Port();// new Port("s21_port_l");
    s21_port_u->~Port();// new Port("s21_port_u");
    s21_port_r->~Port();// new Port("s21_port_r");
    s21_port_d->~Port();// new Port("s21_port_d");
    s22_port_l->~Port();// new Port("s22_port_l");
    s22_port_u->~Port();// new Port("s22_port_u");
    s22_port_r->~Port();// new Port("s22_port_r");
    s22_port_d->~Port();// new Port("s22_port_d");
    s23_port_l->~Port();// new Port("s23_port_l");
    s23_port_u->~Port();// new Port("s23_port_u");
    s23_port_r->~Port();// new Port("s23_port_r");
    s23_port_d->~Port();// new Port("s23_port_d");
    s24_port_l->~Port();// new Port("s24_port_l");
    s24_port_u->~Port();// new Port("s24_port_u");
    s24_port_r->~Port();// new Port("s24_port_r");
    s24_port_d->~Port();// new Port("s24_port_d");
    s25_port_l->~Port();// new Port("s25_port_l");
    s25_port_u->~Port();// new Port("s25_port_u");
    s25_port_r->~Port();// new Port("s25_port_r");
    s25_port_d->~Port();// new Port("s25_port_d");
    s26_port_l->~Port();// new Port("s26_port_l");
    s26_port_u->~Port();// new Port("s26_port_u");
    s26_port_r->~Port();// new Port("s26_port_r");
    s26_port_d->~Port();// new Port("s26_port_d");
    s27_port_l->~Port();// new Port("s27_port_l");
    s27_port_u->~Port();// new Port("s27_port_u");
    s27_port_r->~Port();// new Port("s27_port_r");
    s27_port_d->~Port();// new Port("s27_port_d");
    s28_port_l->~Port();// new Port("s28_port_l");
    s28_port_u->~Port();// new Port("s28_port_u");
    s28_port_r->~Port();// new Port("s28_port_r");
    s28_port_d->~Port();// new Port("s28_port_d");
    s29_port_l->~Port();// new Port("s29_port_l");
    s29_port_u->~Port();// new Port("s29_port_u");
    s29_port_r->~Port();// new Port("s29_port_r");
    s29_port_d->~Port();// new Port("s29_port_d");
    s30_port_l->~Port();// new Port("s30_port_l");
    s30_port_u->~Port();// new Port("s30_port_u");
    s30_port_r->~Port();// new Port("s30_port_r");
    s30_port_d->~Port();// new Port("s30_port_d");
    s31_port_l->~Port();// new Port("s31_port_l");
    s31_port_u->~Port();// new Port("s31_port_u");
    s31_port_r->~Port();// new Port("s31_port_r");
    s31_port_d->~Port();// new Port("s31_port_d");
    s32_port_l->~Port();// new Port("s32_port_l");
    s32_port_u->~Port();// new Port("s32_port_u");
    s32_port_r->~Port();// new Port("s32_port_r");
    s32_port_d->~Port();// new Port("s32_port_d");
    s33_port_l->~Port();// new Port("s33_port_l");
    s33_port_u->~Port();// new Port("s33_port_u");
    s33_port_r->~Port();// new Port("s33_port_r");
    s33_port_d->~Port();// new Port("s33_port_d");
    s34_port_l->~Port();// new Port("s34_port_l");
    s34_port_u->~Port();// new Port("s34_port_u");
    s34_port_r->~Port();// new Port("s34_port_r");
    s34_port_d->~Port();// new Port("s34_port_d");
    s35_port_l->~Port();// new Port("s35_port_l");
    s35_port_u->~Port();// new Port("s35_port_u");
    s35_port_r->~Port();// new Port("s35_port_r");
    s35_port_d->~Port();// new Port("s35_port_d");
    s36_port_l->~Port();// new Port("s36_port_l");
    s36_port_u->~Port();// new Port("s36_port_u");
    s36_port_r->~Port();// new Port("s36_port_r");
    s36_port_d->~Port();// new Port("s36_port_d");
    s37_port_l->~Port();// new Port("s37_port_l");
    s37_port_u->~Port();// new Port("s37_port_u");
    s37_port_r->~Port();// new Port("s37_port_r");
    s37_port_d->~Port();// new Port("s37_port_d");
    s38_port_l->~Port();// new Port("s38_port_l");
    s38_port_u->~Port();// new Port("s38_port_u");
    s38_port_r->~Port();// new Port("s38_port_r");
    s38_port_d->~Port();// new Port("s38_port_d");
    s39_port_l->~Port();// new Port("s29_port_l");
    s39_port_u->~Port();// new Port("s29_port_u");
    s39_port_r->~Port();// new Port("s29_port_r");
    s39_port_d->~Port();// new Port("s29_port_d");
    s40_port_l->~Port();// new Port("s40_port_l");
    s40_port_u->~Port();// new Port("s40_port_u");
    s40_port_r->~Port();// new Port("s40_port_r");
    s40_port_d->~Port();// new Port("s40_port_d");
    s41_port_l->~Port();// new Port("s41_port_l");
    s41_port_u->~Port();// new Port("s41_port_u");
    s41_port_r->~Port();// new Port("s41_port_r");
    s41_port_d->~Port();// new Port("s41_port_d");
    s42_port_l->~Port();// new Port("s42_port_l");
    s42_port_u->~Port();// new Port("s42_port_u");
    s42_port_r->~Port();// new Port("s42_port_r");
    s42_port_d->~Port();// new Port("s42_port_d");
    s43_port_l->~Port();// new Port("s43_port_l");
    s43_port_u->~Port();// new Port("s43_port_u");
    s43_port_r->~Port();// new Port("s43_port_r");
    s43_port_d->~Port();// new Port("s43_port_d");
    s44_port_l->~Port();// new Port("s44_port_l");
    s44_port_u->~Port();// new Port("s44_port_u");
    s44_port_r->~Port();// new Port("s44_port_r");
    s44_port_d->~Port();// new Port("s44_port_d");
    s45_port_l->~Port();// new Port("s45_port_l");
    s45_port_u->~Port();// new Port("s45_port_u");
    s45_port_r->~Port();// new Port("s45_port_r");
    s45_port_d->~Port();// new Port("s45_port_d");
    s46_port_l->~Port();// new Port("s46_port_l");
    s46_port_u->~Port();// new Port("s46_port_u");
    s46_port_r->~Port();// new Port("s46_port_r");
    s46_port_d->~Port();// new Port("s46_port_d");
    s47_port_l->~Port();// new Port("s47_port_l");
    s47_port_u->~Port();// new Port("s47_port_u");
    s47_port_r->~Port();// new Port("s47_port_r");
    s47_port_d->~Port();// new Port("s47_port_d");
    s48_port_l->~Port();// new Port("s48_port_l");
    s48_port_u->~Port();// new Port("s48_port_u");
    s48_port_r->~Port();// new Port("s48_port_r");
    s48_port_d->~Port();// new Port("s48_port_d");
    s49_port_l->~Port();// new Port("s49_port_l");
    s49_port_u->~Port();// new Port("s49_port_u");
    s49_port_r->~Port();// new Port("s49_port_r");
    s49_port_d->~Port();// new Port("s49_port_d");
    s50_port_l->~Port();// new Port("s50_port_l");
    s50_port_u->~Port();// new Port("s50_port_u");
    s50_port_r->~Port();// new Port("s50_port_r");
    s50_port_d->~Port();// new Port("s50_port_d");
    */
    testex.clear();
    //testex.~vector();
