...
public:
    //ctor
  SatExperiment(PrIns* tmpPrInst,unsigned int tmpChCount,unsigned int tmpSwInst,unsigned int tmpChInst,unsigned int tmpRuns){
...
int main_function(int argc, char *argv[])
{
    ...
    */
    ...
    SatExperiment* se= new SatExperiment(p1,chCount, swInst, chInst, runs);
